...
"properties":{
 "provenance":{"type":"object",
  ...
  "properties":{
   ...
   "caps":{"type":"array","items":{"type":"string"},"description":"o que a COLETA conseguiu; o que falta explica a cobertura. CANÔNICO: remontado a partir do conjunto que este binário conhece, cada capacidade no máximo uma vez — o dump não escolhe o tamanho desta lista"},
   "unknown_caps_count":{"type":"integer","description":"quantos nomes de capacidade do artefato este binário não reconhece. Contados, e não ecoados: o dump não é autenticado, e repetir nomes escolhidos pelo alvo devolveria a ele o controle do tamanho da resposta"},
