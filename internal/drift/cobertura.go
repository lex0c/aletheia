...
var NaoCobertas = []Superficie{
	...
	{Nome: "seleção de log ampliada (--logs-all)", Campo: "log_selection_expanded",
		Porque: "parâmetro da coleta, não estado do host"},
	{Nome: "fontes de log cortadas pelo teto", Campo: "log_families_truncated",
		Porque: "sinal de cobertura"},
